...
const styles = StyleSheet.create({
  ...
  chip: { borderWidth: 1, borderColor: '#E4E4E7', backgroundColor: colors.card, borderRadius: radius.card, paddingVertical: spacing.lg, paddingHorizontal: spacing.md, minHeight: 48, justifyContent: 'center' },
